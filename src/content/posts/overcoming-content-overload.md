---
title: "Overcoming Content Overload"
description: ""
tags:
  - mediations
...
I [consider friction](/newsletter/mediations-1/) as a fundamental element of productivity and intellect. Friction, inconvenience, and [constraints are enablers of creativity](/love-the-constraints/), productivity and quality. Learning to live with them, or even leverage them, positions us to face reality rather than an illusion of convenience. Friction forces you to find new ways of doing things.
...
I wrote before that [I avoid using algorithmic feeds in almost everything](/living-without-algorithms) (algorithms are optimized to increase the owner’s profit, not the user’s benefit). I curate my own feed using the [Readwise Reader app](https://readwise.io/read).
...
For books, [I don't buy any in the same year they are published](/decisions-that-remove-other-decisions/). I keep a Markdown file similar to movie-watchlist. When I want to learn a topic, I research books but never read the reviews. When I find one I want to buy, I add it to my list and apply a time test. If I can, I go to a bookstore and [skim the book there](/how-to-get-to-the-end-of-a-pile-of-unread-books/), reading a paragraph or a page here and there before buying it (this doesn’t always work, as I can’t always find all English or Turkish books in bookstores in Berlin).
...
Before I share these questions, let's test it together. When you read the questions below, don't continue further. Pause for two seconds, then answer them for yourself. If you answer with _”no” to all of them_, stop reading this post. Seriously. Don't read the rest; it won't be worth your time.
...
- Is this something that will give me fun/joy/mindfulness/relaxation/... and I want that _right now_?
...
Focusing on understanding what I consume required me to build [other habits](/my-experience-living-without-social-media/) that [I had written about](/no-more-debate-with-latest-or-daily-news/) on [my blog](/i-cant-worry-about-the-whole-world/) before.

I almost always read with a pen in hand, use index cards or my reMarkable tablet to take notes, [move my notes later to Obsidian, and apply methods from the Zettelkasten system to connect notes with each other](/concluding-my-struggle-with-note-taking-systems-and-apps-finally/). While taking notes and making those connections, I understand. Then I try to share what I understand on my blog to force myself to fully comprehend it, think it through, and reflect on it in my own words.

---

All of these **take time**. The optimization here isn’t about [catching up on daily trends](/embracing-the-joy-of-missing-out/), reading all the latest blog posts, or watching the most recent movies or videos. It's about consuming wisely and [improving the quality of the ideas or information](/speaking-writing-and-high-quality-ideas/) I'm exposed to.
...
1. I add it to Readwise Reader and never open it right away.
2. When I have time later for content (e.g., on the subway), I open the app.
3. I pick a content and skim over it and check if I still find it interesting.
4. If yes, I ask the three questions I shared above.
5. If I answer at least one “yes,” I engage with the content (while ideally taking notes if it’s non-fiction).
6. I move on to the next content.
7. Later on, I move content notes to my permanent notes and connect them to other notes.

For the content I’m subscribed to, they arrive in the Feed section of the Readwise Reader app.

1. I open the content from the Feed.
2. I skim over and check if I still find it interesting or think that it’s something I want to know/learn/have fun with (if it’s a video, I watch parts of it for ~10-15s)
3. If I think I want to spend time with it, I move it to Readwise Reader’s Inbox.
4. Clean up the whole Feed by repeating steps 1-3.
5. I open Readwise Reader’s Inbox and find a piece of content.
6. I ask the three questions I shared above.
7. If I have at least one answer with “yes,” I engage with the content (while ideally taking notes if it’s non-fiction).
8. Move on to the next content.
9. Later on, I move content notes to my permanent notes and connect them to other notes.

_**P.S.** Some of the above strategies also apply to fiction material, but not all. When I want to have fun, I approach it a little differently. I still collect them in a central database (if digital content, in Readwise Reader; if physical, I add it to my list before buying), but I don’t skim over or engage with them in multiple steps. Once I start, I aim to finish it as soon as possible to keep the story and fun intact._
