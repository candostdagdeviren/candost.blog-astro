---
title: "Distributed Discussions"
description: "A subtle shift in an Internet user's behavior might change the world."
tags:
  - mediations
newsletterName: "Mediations"
issueNumber: "29"
date: 2025-11-11T09:05:00.000Z
updateDate: 2025-11-11T09:05:00.000Z
---

Back in the late 90s, the Internet wasn’t readily available in my hometown. As it was costly, my parents couldn’t afford it. At that time, blogs were the TikTok or Instagram of today. By the time the Internet became accessible, social media websites like Facebook and Twitter were in full swing. Naturally, I caught the end of the blogging era and grew up with social media. Yet, I still dug into blogs and finally jumped on the train around 2011 and published my first blog article (_on Blogger, neither the post nor the blog survived_).
...
I acknowledge that not all blogs offer a commenting mechanism, forcing everyone to move discussions elsewhere (the chicken and egg problem). Often, the reason for this choice comes down to maintaining infrastructure, comments, and spam. Many bloggers (rightfully) don’t want to deal with that as they want to focus on the content. One or two real comments per year don’t justify the cost and effort (_I do maintain a commenting system on [my blog here](/)_). However, once the blogger decides to have it, we owe a response in the place it’s published, if we are to respond.

## Good to Great

_I share max three things I found interesting, sorted by good to great._

Good: The question,“_What is the purpose of a corporation? Is it solely to maximise shareholder value, as some free-market purists argue? Or does it bear responsibility to a broader set of values and stakeholders?_” led a group of researchers to study Chinese companies that are closer to temples and how they distribute their profits. Read the “[In China, companies that are closer to temples are more generous to shareholders: religion subtly shapes economic behaviour](https://aeon.co/essays/how-chinese-religious-traditions-shape-corporate-generosity)” by Zhangxin (Frank) Liu.

Better: “_Technology is the active human interface with the material world._” A great definition of technology from my favorite author. She wrote this in 2005, and I still haven’t seen a better definition. [“A Rant About Technology” by Ursula K. Le Guin](https://www.ursulakleguin.com/a-rant-about-technology).

Great: “_I deeply believe in environments that cause people to accomplish bigger and better things than what they imagined they could have done,_” says Tobi Lütke, CEO of Shopify. Listen to Tobi Lütke’s [great conversation](https://youtu.be/eMSqlQMk480) with Stripe’s John Collison.

Until next time,

Candost

_P.S. I signed up to [Berlin Triathlon](https://www.berlin-triathlon.de/) (June 6-7) to challenge myself and train during winter. If you wanna join me (or join another event), just send me a email/message/comment and we can form an accountability group._
