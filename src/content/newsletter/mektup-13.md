...
To change our perspective and [move from "I" to "we,"](/newsletter/mektup-9/) we first need to *identify and name* the situation. Naming the conflict is the first step toward acceptance.
...
Next, ***ask yourself how you contribute to the problem***. Remember that any relationship has three attributes (you, another person, and the relationship). Which one are you focusing on? Move your focus to the relationship and analyze how you contribute to it.
