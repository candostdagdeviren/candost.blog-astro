...
- Writing is thinking. It shapes thoughts. We *learn* fresh ideas when we write them. Whatever we read, watch, and listen to is not ours. We internalise them by writing them in complete sentences.
...
- **Related Note(s):**
  ...
  - [Writing brings the habits from the automatic brain to awareness](/notes/27a/).
  - [The writing has to reach to the audience at some point without falling into the editing trap](/notes/39/).
  - [A strategy to unlock the writer’s block](/notes/2c/).
