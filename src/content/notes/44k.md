...
When we find common ground and realize that we can actually focus on the _how_ part of the problem, we expose ourselves to different perspectives—we overcome binary bias. Coming to this position is not easy. When we face unknowns and uncertainties, we raise our defensive walls.
