...
Similar to the business need we talked about above, the business decision has to be made before writing an RFC. RFC focuses on _how_, not _what_—deciding on _what_ has to be done earlier.
