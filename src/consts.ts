...
[
  ...
  },
  {
    ...
    description: 'Working on governance, risk, and social patterns across federated & decentralized systems. Previously: COVID Tracking Project + Knight Mozilla OpenNews + editorial and community in tech and culture orgs.'
  },
  {
    name: "Tren's Blog",
    url: 'https://25iq.com/',
  ...
  },
  {
    ...
    description: 'wvdial, bup, sshuttle, netselect, popularity-contest, redo, gfblip, GFiber, and now @Tailscale doing WireGuard mesh.'
  },
  {
    name: "Ashley Janssen Consulting",
    url: 'https://ashleyjanssen.com/blog/',
    description: 'Productivity is about being intentional about how you spend your time, energy, and attention in all parts of your life.'
  },
  {
    name: "Brave New Geek",
  ...
  },
  {
    ...
    description: 'charity wtf is about technology, databases, startups, engineering management, and whiskey.'
  },
  {
    name: "Craig Mod",
  ...
  },
  {
    name: "Derek Sivers",
    url: 'https://sive.rs/',
    description: 'Derek is a musician, circus performer, entrepreneur, and speaker. Derek is a slow thinker, explorer, xenophile, and loves a different point of view.'
  },
  {
    name: "Cat Hicks, PhD",
    url: 'https://www.drcathicks.com/',
    description: "Cat is a psychologist studying software teams, a research leader, an empirical interventionist, and a creative entrepreneur."
  },
  {
    name: "everything changes",
    url: 'https://everythingchanges.us/',
    description: 'Regular posts about what it takes to do your best work—even as everything changes.'
  },
  {
    name: "Fatih Arslan",
    url: 'https://arslan.io/',
    description: 'Software Engineer. Fatih\'s reflection on his life and hobbies, such as Photography, Design, Programming, and Traveling.'
  },
  {
    name: "Fred Hebert",
    url: 'https://ferd.ca/',
    description: 'Fred Hebert is a staff SRE at Honeycomb.io, caring for SLOs and error budgets, on-call health, alert hygiene, incident response, and operational readiness.'
  },
  {
    name: "Uwe Friedrichsen",
    url: 'https://ufried.com/blog/',
    description: 'Uwe Friedrischen is a CTO, software architect, and consultant with a focus on software architecture, technical leadership, and organizational transformation.'
  },
  {
    name: "Hazel Weakly",
    url: 'https://hazelweakly.me/',
    description: 'Hazel currently spends the days working on building out teams of humans as well as the infrastructure, systems, automation, and tooling to make life better for others.'
  },
  {
  ...
  },
  {
    ...
    description: 'Will is a software engineering leader and writer, currently serving as Carta’s CTO'
  },
  {
    name: "Jessica Kerr",
  ...
  },
  {
    ...
    description: 'Martin is an author, speaker… essentially a loud-mouthed pundit on the topic of software development, primarily for Enterprise Applications'
  },
  {
    name: "Martin Kleppmann's Blog",
    url: 'https://martin.kleppmann.com/',
    description: 'Martin is an Associate Professor working on local-first software and security protocols at the University of Cambridge.'
  },
  {
    name: "Murat Demirbas",
    url: 'https://muratbuffalo.blogspot.com/',
    description: 'Murat is a principal research scientist at MongoDB Research. The blog is on distributed systems broadly defined and other curiosities.'
  },
  {
  ...
  },
  {
    ...
    description: 'My not-so-profound thoughts about valuation, corporate finance and the news of the day!'
  },
  {
    name: "Neil Gaiman's Journal",
    url: 'http://journal.neilgaiman.com/',
    description: 'Neil started February 2001 when nobody knew what the word Blog meant. Talking about writing, comics, books, films, bees, demonic tomatoes, cats, travel and a dog ever since.'
  },
  {
    name: "Paul Graham",
  ...
  },
  {
    ...
    description: 'A developer building software for CodePen, wife, mother of two, productivity nerd and recovering screen addict. This is Rach\'s digital garden.'
  },
  {
  ...
  },
  {
    ...
    description: 'Every so often, a new set of three writing prompts will magically appear, along with a smidge of writing advice.'
  },
  {
  ...
  },
  {
    ...
    description: 'Principal Engineer at Google. Gemini API, AI Studio and other AI developer tools. Optimism and simplicity.'
  },
  {
  ...
  },
  {
    ...
    description: 'A weekly dose of curated practical wisdom for technical leaders.'
  },
  {
    name: "The Kool-Aid Factory",
    url: 'https://koolaidfactory.com/',
    description: 'The Kool-Aid Factory is a series of zines about the ways organizations coordinate.'
  },
  {
    name: "The Prism",
  ...
  },
  {
    ...
    description: 'A weekly newsletter on how to be a sharper marketer, founder, and builder'
  },
  {
  ...
  },
  {
    ...
    description: 'Prepare for the unexpected so you can protect your life, health and wealth.'
  },
  {
  ...
  },
  {
    ...
    description: 'Diving into tech, business, management, and career tips, sprinkled with occasional detours into philosophy and economics'
  },
  {
    name: "Byte Byte Go",
    url: 'https://blog.bytebytego.com/',
    description: 'Explain complex systems with simple terms, from the authors of the best-selling system design book series.'
  },
]